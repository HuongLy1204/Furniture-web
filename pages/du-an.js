...
import { projectThunk } from '../components/works/projectSlice'
...
export default function ProjectPage() {
  ...
  useEffect(()=>{
    const actionResult = dispatch(projectThunk())
    const projects = unwrapResult(actionResult)
    console.log(actionResult, "project");
  },[])
